...
module.exports = async req => {
  ...
  console.log("planner: running completion");
  ...
  console.log("planner: completion completed");

  fs.writeFileSync("./data/current_plan.json", completion.choices[0].message.content);
  fs.writeFileSync("./data/initial_plan.json", completion.choices[0].message.content);
  fs.writeFileSync("./data/adjustments.json", JSON.stringify([
